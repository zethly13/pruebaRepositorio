...
<div class="panel panel-default">  
  <div class="panel-heading text-center">FORMULARIO DE REGISTRO</div>
    ...
    {!! Form::open(array('route' =>array('usuarios.store'), 'method' => 'POST'), array('role'=> 'form')) !!}
      <!--inicio de mi formulario-->
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">{!! Form::text('apellido_usuario',null,array('placeholder' => 'Ingrese apellido','class'=>'form-control')) !!}</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-9">{{ Form::email('email_usuario',null,array('placeholder' => 'example@gmail.com','class'=>'form-control')) }}</div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">{{ Form::text('direcion_usuario',null,array('placeholder' => 'Ingrese direccion','class'=>'form-control')) }}</div>
        </div>
 ...
 {!! Form::close() !!}
</div><!--cierre formulario horizontal-->
